...
var hljs = (function () {
  ...
  return (function (t) {
    ...
    function m(e, t, a, s) {
      ...
      function h(e) {
        return (
          e.className && O.openNode(e.className), (y = Object.create(e, { parent: { value: y } }))
        );
      }
      function p(e) {
      ...
      function x(t, r) {
        ...
        if (((b = r), "begin" === r.type))
          return (function (e) {
            ...
            return (
              r &&
                r.endSameAsBegin &&
                (r.endRe = RegExp(t.replace(/[-/\\^$*+?.()|[\]{}]/g, "\\$&"), "m")),
              r.skip
                ? (A += t)
                : (r.excludeBegin && (A += t), u(), r.returnBegin || r.excludeBegin || (A = t)),
              h(r),
        ...
        if ("illegal" === r.type && !a) {
          const e = Error(
            'Illegal lexeme "' + i + '" for mode "' + (y.className || "<unnamed>") + '"'
          );
          throw ((e.mode = y), e);
        }
        if ("end" === r.type) {
          var s = (function (e) {
            ...
            i.skip
              ? (A += t)
              : (i.returnEnd || i.excludeEnd || (A += t), u(), i.excludeEnd && (A = t));
            do {
    ...
    return function (t) {
      ...
      return {
        ...
        contains: [
          ...
          { beginKeywords: "new", end: /\{/, excludeEnd: !0 },
          {
            begin: "(get|set)\\s+(?=" + i + "\\()",
            end: /{/,
            keywords: "get set",
